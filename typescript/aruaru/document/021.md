# #021 「`NonNullable`で救われたのに感謝されない悲劇」制作ドキュメント

## 台本
ずんだもん「TypeScript書いてるとさ、`NonNullable`で救われたのに感謝されない悲劇って絶対あるよね？」
四国めたん「わかります。`unknown`を`any`に戻したくなる誘惑と戦い続けますよね」
ずんだもん「しかもそのまま`NonNullable`で救われたのに感謝されない悲劇状態になって、チーム全員が固まるんだよ！」
四国めたん「そこでTypeScriptの`unknown`ガードを使えば、型ガードで`unknown`を段階的に狭めれば安心です」
ずんだもん「いや待って、それやると`NonNullable`で救われたのに感謝されない悲劇第2ラウンドが始まるやつ！」
...
## 制作メモ
- **想定シーン**: `NonNullable`で救われたのに感謝されない悲劇に遭遇した瞬間を切り取るネタ
