# #074 「`resolveJsonModule`が便利すぎてやめられない」制作ドキュメント

## 台本
ずんだもん「TypeScript書いてるとさ、`resolveJsonModule`が便利すぎてやめられないって絶対あるよね？」
四国めたん「わかります。ESMとCJSの狭間で迷子になるのは週間行事ですよね」
ずんだもん「しかもそのまま`resolveJsonModule`が便利すぎてやめられない状態になって、チーム全員が固まるんだよ！」
四国めたん「そこでTypeScriptのモジュール解像度の整理を使えば、`module`と`moduleResolution`を合わせて揃えるのが近道です」
ずんだもん「いや待って、それやると`resolveJsonModule`が便利すぎてやめられない第2ラウンドが始まるやつ！」
...
## 制作メモ
- **想定シーン**: `resolveJsonModule`が便利すぎてやめられないに遭遇した瞬間を切り取るネタ
- **狙いトーン**: 混乱を笑いに変えるカオス系
