# #066 「`asserts`を使いこなしたいのに忘れるやつ」制作ドキュメント

## 台本
ずんだもん「TypeScript書いてるとさ、`asserts`を使いこなしたいのに忘れるやつって絶対あるよね？」
四国めたん「わかります。`unknown`を`any`に戻したくなる誘惑と戦い続けますよね」
ずんだもん「しかもそのまま`asserts`を使いこなしたいのに忘れるやつ状態になって、チーム全員が固まるんだよ！」
四国めたん「そこでTypeScriptの`unknown`ガードを使えば、型ガードで`unknown`を段階的に狭めれば安心です」
ずんだもん「いや待って、それやると`asserts`を使いこなしたいのに忘れるやつ第2ラウンドが始まるやつ！」
...
## 制作メモ
- **想定シーン**: `asserts`を使いこなしたいのに忘れるやつに遭遇した瞬間を切り取るネタ
