# #072 「`verbatimModuleSyntax`をONにして戸惑う瞬間」制作ドキュメント

## 台本
ずんだもん「TypeScript書いてるとさ、`verbatimModuleSyntax`をONにして戸惑う瞬間って絶対あるよね？」
四国めたん「わかります。ESMとCJSの狭間で迷子になるのは週間行事ですよね」
ずんだもん「しかもそのまま`verbatimModuleSyntax`をONにして戸惑う瞬間状態になって、チーム全員が固まるんだよ！」
四国めたん「そこでTypeScriptのモジュール解像度の整理を使えば、`module`と`moduleResolution`を合わせて揃えるのが近道です」
ずんだもん「いや待って、それやると`verbatimModuleSyntax`をONにして戸惑う瞬間第2ラウンドが始まるやつ！」
...
## 制作メモ
- **想定シーン**: `verbatimModuleSyntax`をONにして戸惑う瞬間に遭遇した瞬間を切り取るネタ
- **狙いトーン**: 混乱を笑いに変えるカオス系
