# #051 「`as unknown as`で無理やり通した後悔」制作ドキュメント

## 台本
ずんだもん「TypeScript書いてるとさ、`as unknown as`で無理やり通した後悔って絶対あるよね？」
四国めたん「わかります。`unknown`を`any`に戻したくなる誘惑と戦い続けますよね」
ずんだもん「しかもそのまま`as unknown as`で無理やり通した後悔状態になって、チーム全員が固まるんだよ！」
四国めたん「そこでTypeScriptの`unknown`ガードを使えば、型ガードで`unknown`を段階的に狭めれば安心です」
ずんだもん「いや待って、それやると`as unknown as`で無理やり通した後悔第2ラウンドが始まるやつ！」
...
## 制作メモ
- **想定シーン**: `as unknown as`で無理やり通した後悔に遭遇した瞬間を切り取るネタ
