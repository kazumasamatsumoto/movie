# #035 「`async function`の戻り値、ユニオンどう扱う？」制作ドキュメント

## 台本
ずんだもん「`async function`の戻り値、ユニオンどう扱う？」
四国めたん「非同期戻り値の扱いは`async function`の戻り値、ユニオンどう扱うでも議論が尽きませんね」
...
## 制作メモ
- **問いの切り口**: `async function`の戻り値、ユニオンどう扱う？
