# #013 「`async/await`の戻り型、どう管理してる？」制作ドキュメント

## 台本
ずんだもん「`async/await`の戻り型、どう管理してる？」
四国めたん「非同期戻り値の扱いは`async/await`の戻り型、どう管理してるでも議論が尽きませんね」
...
## 制作メモ
- **問いの切り口**: `async/await`の戻り型、どう管理してる？
